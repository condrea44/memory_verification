...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x40b950)) ;
...
extern "C" {
	...
	extern void subprog_m_a9dabdb_556ead11_2255(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		SP = DPIInitializeFunction(IP + 423816, 168, 427704) ;
		char driver0[32] ;
		...
		DPIInvokeFunction(IP + callingProcessOffset, SP, (void*)(subprog_m_a9dabdb_556ead11_2255), IP) ;
